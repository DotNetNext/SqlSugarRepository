...
{
    internal class OracleSqlable : ISqlable
    {
        ...
        {
            sqlable= sqlable.Join(tableName, shortName, leftFiled, rightFiled, (OracleSugar.JoinType)(int)type);
            return this;
        }
        ...
        {
            sqlable= sqlable.Join<T>(shortName, leftFiled, rightFiled, (OracleSugar.JoinType)(int)type);
            return this;
        }
        ...
        {
            sqlable= sqlable.Apply(applySql, shotName, (OracleSugar.ApplyType)(int)type);
            return this;
        }
