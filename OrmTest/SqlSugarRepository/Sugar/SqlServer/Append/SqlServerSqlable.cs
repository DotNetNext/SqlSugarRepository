...
{
    internal class SqlServerSqlable : ISqlable
    {
        ...
        {
            sqlable= sqlable.Join(tableName, shortName, leftFiled, rightFiled, (SqlSugar.JoinType)(int)type);
            return this;
        }
        ...
        {
            sqlable= sqlable.Join<T>(shortName, leftFiled, rightFiled, (SqlSugar.JoinType)(int)type);
            return this;
        }
        ...
        {
            sqlable= sqlable.Apply(applySql, shotName, (SqlSugar.ApplyType)(int)type);
            return this;
        }
