        ...
        public void Init(DbType type)
        {
            ...
            using (var db = SugarDao.GetInstance(type))
            {
               ...
               // var str2 = db.ClassGenerating.SqlToClass(db, "select top 1 * from Student", "student");
                ...
                var tempItem = SqlSugar.ClassTemplate.ItemTemplate;//例如可以在生成的实体添加默认构造函数给指定的字段赋默认值或者公司信息等
                var temp = SqlSugar.ClassTemplate.Template;
                var temSummary = SqlSugar.ClassTemplate.ClassFieldSummaryTemplate;
                ...
                MySqlSugar.ClassTemplate.Template =
                OracleSugar.ClassTemplate.Template =
                SQLiteSugar.ClassTemplate.Template =
                SqlSugar.ClassTemplate.Template = "using System;\r\nusing System.Linq;\r\nusing System.Text;\r\n\r\nnamespace $namespace\r\n{\r\n    public class $className\r\n    {\r\n        public $className() \r\n        { \r\n            this.CreateTime = DateTime.Now;\r\n            this.  = 0;\r\n            this.UpdateTime=DateTime.Now;\r\n            this.$primaryKeyName=Guid.NewGuid().ToString(\"N\").ToUpper();\r\n        }\r\n        $foreach\r\n    }\r\n}\r\n";
